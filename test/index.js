 ...
 */
function analyze(context, callback) {
    W(callback);
    x(callback);
    S(callback);
}
 ...
 * @param [callback] Callback
 */
function overwatch(context, callback) {
...
class Monitor {
     ...
     */
    constructor(context) {
        this.context = merge$1({ application: '', server: '', headers: {} }, context);
 ...
 * @param [context] Context
 */
function initiate(server, context = {}) {
